...
export function Footer() {
  return (
    <footer className="relative bg-black border-t border-gold/20 mt-16 hidden md:block">
      <SectionReveal>
      ...
      <div className="absolute bottom-0 left-0 right-0 flex items-end justify-center pointer-events-none h-32">
        <div className="w-96 h-32 bg-[radial-gradient(ellipse_90%_80%_at_50%_65%,_#7D52FD4D_0%,_transparent_59%)] rounded-full"></div>
      </div>
    </footer>
  );
}
